...
public record ClientDisconnectEvent(PacketServer server, Client client, CancelContainer cancelContainer) implements ServerEvent {

    public ClientDisconnectEvent(PacketServer server, Client client) {
